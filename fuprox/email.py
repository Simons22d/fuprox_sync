def body(code):
    body = f"""
             ...
             <p
                     style="color:#586069!important;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',
Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI 
Symbol';font-size:12px!important;font-weight:normal;line-height:1.5;margin:0 0 15px;padding:0;text-align:left" 
align="left">You are receiving this email for password reset. if it was not You please dont use this code.</p>
    ...
    body = f"""
             ...
             <p style="color:#222222;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:14px;font-weight:normal;line-height:1.5;margin:0 0 15px;padding:0;text-align:left" align="left">
                  Dear Sir/Madam, <br><br>
                     ...
                     Your account password has been changed. If This was not you please feel free to review your 
account details. 
t
    ...
    body = f"""
             ...
             <p style="color:#222222;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:14px;font-weight:normal;line-height:1.5;margin:0 0 15px;padding:0;text-align:left" align="left">
                  Dear Sir/Madam, <br><br>
                     ...
                     Please use the code below to actvate your account.
                     <pre>{code}</pre>
                     <br>
                     Kind Regards,<br>
                     IT Support.<br><br><br>
             ...
             <p
                     style="color:#586069!important;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',
                        ...
                        Symbol';font-size:12px!important;font-weight:normal;line-height:1.5;margin:0 0 15px;padding:0;text-align:left" 
                        align="left">
                        You are receiving this email for Account Creation. if it was not You please ingore this message. Thank You.</p>
